...
[0] = LAYOUT(
     ...
     KC_HOME, KC_END, KC_LALT, KC_LGUI,   MO(2),  LT(3, KC_SPC),  LT(3, KC_ENT),   MO(1),  KC_RGUI, KC_RALT, KC_PGUP, KC_PGDN
  ),
...
[2] = LAYOUT(
     KC_ESC,  XXXXXXX, XXXXXXX, KC_TILD, KC_PIPE, KC_LCBR, KC_RCBR,  KC_UNDS, KC_PLUS, KC_NO, KC_NO, RESET,
...
[3] = LAYOUT(
     ...
     _______, KC__VOLDOWN, KC__VOLUP, KC_AUDIO_MUTE, LGUI(KC_RBRC), XXXXXXX, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, XXXXXXX,
     _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, LGUI(KC_LBRC), XXXXXXX, LCTL(RSFT(KC_TAB)), LCTL(KC_TAB), XXXXXXX, XXXXXXX, XXXXXXX,
     _______, _______, _______, _______,   MO(2), _______, _______,   MO(1), _______, _______, _______, _______
  ),
};
