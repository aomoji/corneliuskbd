...
[3] = LAYOUT(
     _______, LCTL(KC_1), LCTL(KC_2), LCTL(KC_3), LCTL(KC_4), LCTL(KC_5), LCTL(KC_6), LCTL(KC_7), LCTL(KC_8), LCTL(KC_9), LCTL(KC_0), KC_F15,
     _______, KC__VOLDOWN, KC__VOLUP, LCTL(RSFT(KC_TAB)), LGUI(KC_RBRC), LCTL(KC_TAB), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, KC_F14,
     _______, LCTL(KC_PGUP), LCTL(KC_PGDN), LGUI(KC_MINS), LGUI(KC_PLUS), LGUI(KC_LBRC), XXXXXXX, LALT(KC_LEFT), LALT(KC_RIGHT), RGUI(KC_SPACE), XXXXXXX, XXXXXXX,
